          ...
          <div class="work-smarter-tabs">
            ...
            <?php while(have_rows('work_repeater'))  : the_row(); ?>
              <li class="nav-item" role="presentation">
                <button class="nav-link <?php if($i==0){echo 'active';} ?>" id="account-tab" data-bs-toggle="pill" data-bs-target="#create-account-content-<?php echo $i; ?>" type="button" role="tab"><?php the_sub_field('work_item_title'); ?></button>
              </li> 
            ...
            ?>
              <div class="tab-pane fade <?php if($i==0){echo 'show active';} ?>" id="create-account-content-<?php echo $i; ?>" role="tabpanel" tabindex="0">
